  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 pr-3 border-r border-border/50">
        <span className="text-xs font-display text-muted-foreground uppercase tracking-wider">Tour de</span>
        <span className="text-sm font-display font-bold text-foreground">{activePlayer.name}</span>
      </div>

      {/* Mode indicator */}
      {interactionMode !== 'idle' && (
        <div className="flex items-center gap-1.5 px-2 py-1 rounded-lg text-xs font-display font-semibold"
      ...
      {/* Action buttons */}
      <motion.button
        className={`flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-display font-semibold transition-all ${
      ...
      <motion.button
        className={`flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-display font-semibold border border-divine/30 text-foreground transition-all ${
      ...
      <motion.button
        className="flex items-center gap-1 px-3 py-2 rounded-lg text-xs font-display border border-reaction/30 text-reaction transition-all"
      ...
      <motion.button
        className="flex items-center gap-1 px-4 py-2 rounded-lg text-xs font-display font-semibold text-foreground transition-all border border-border/50"
