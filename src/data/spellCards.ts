...
export const SPELL_TEMPLATES: SpellTemplate[] = [
  ...
  },
  {
    ...
    effect: 'Le mortel n\'est finalement pas métamorphosé. Le coût reste payé.',
  ...
  },
  {
    ...
    cost: 8,
    targets: 'un mortel propre',
    activationCondition: 'Un mortel propre est ciblé par un effet ennemi, OU vous avez un mortel incapacité',
    effect: 'Protégez votre mortel : l\'effet ennemi est annulé (coûts restent payés). OU : levez une incapacité.',
